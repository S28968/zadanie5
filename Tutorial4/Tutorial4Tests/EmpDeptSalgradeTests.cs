...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps
            .Where(e => depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo).Contains(e.DeptNo)).ToList();
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(x => new { x.EName, x.Sal }).ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm != null).Select(x => new
        {
            x.EName,
            x.Comm
        }).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => emps.Where(e2 => e.DeptNo == e2.DeptNo).Average(avg => avg.Sal) < e.Sal)
